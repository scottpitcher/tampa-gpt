...
# text_processing("New York City, a city within New York State, is the most populated city in the country. Even though the city is expensive to live in, there are many things to do there!")
...
# Using the new text_processing function, we will create examples from the paragraphs in the above variables
    for i, paragraph in enumerate(paragraphs):
        print(f"Currently proceessing paragraph: {i}")
        example_messages = []
        example_messages.append({"role":"system", "content":system_prompt})
        example_messages.append({"role":"user", "content":user_prompt+paragraph})
